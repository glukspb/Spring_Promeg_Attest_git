...
import com.example.springsecurityapplication.util.OtborOrder;
...
public class OrderService {
    ...
    public OrderService(OrderRepository orderRepository, OrderShapkiRepository orderShapkiRepository) {
    ...
    // Данный метод позволяет вернуть все шапки заказав2
