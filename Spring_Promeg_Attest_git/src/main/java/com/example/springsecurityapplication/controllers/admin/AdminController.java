...
//    }
    ...
    @Autowired
    public AdminController(ProductService productService, CategoryRepository categoryRepository, OrderService orderService, CartRepository cartRepository, OrderRepository orderRepository, OrderShapkiRepository orderShapkiRepository, OrderStrokiRepository orderStrokiRepository, StatusesRepository statusesRepository, PersonService personService, PersonRepository personRepository, RolesRepository rolesRepository) {
        this.productService = productService;
...
//        }
        ...
        if (imageList.size() >=1) {
            ...
            System.out.println("file_one = " + file_one);
